...
- [ ] Change the default MYRIAD SYMBOL to reflect Desired Branding (UPDATE: adobe logo info file has icon information)

- [ ] change all github links to point to the proper site
- [ ] change demo link to hosted site

- [ ] there are logos for light and dark theme that were generated by Adobe Express, figure out how to swap them when the theme is toggled in the nav bar (added them to same location as current logo)
- [ ] public/logo-info.txt has color and icon information from the Adobe Express generated logo, lets update our styling to match

- [ ] Change the favicon in `public` to the icon from adobe
